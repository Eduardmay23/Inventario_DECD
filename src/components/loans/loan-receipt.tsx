...
// Componente de clase para el contenido que se va a imprimir
// react-to-print funciona de manera más fiable con componentes de clase o forwardRef
class PrintableReceipt extends React.Component<{ loan: Loan; entregadoPor: string; recibidoPor: string; onEntregadoChange: (e: React.ChangeEvent<HTMLInputElement>) => void; onRecibidoChange: (e: React.ChangeEvent<HTMLInputElement>) => void;}> {
  render() {
    const { loan, entregadoPor, recibidoPor, onEntregadoChange, onRecibidoChange } = this.props;
    return (
            ...
            <div className="mt-24 grid grid-cols-2 gap-8 pt-12">
                <div className="text-center">
                    ...
                    <input
                        ...
                        className="w-3/4 mx-auto border-0 text-center text-xs focus:outline-none focus:ring-0 bg-transparent text-gray-500 print-input-value"
                        value={entregadoPor}
                        onChange={onEntregadoChange}
                    />
                </div>
                <div className="text-center">
                    <div className="border-t border-gray-400 w-3/4 mx-auto mb-2">&nbsp;</div>
...
export function LoanReceipt({ loan }: { loan: Loan }) {
  const componentRef = useRef<PrintableReceipt>(null);
    ...
    <div>
      ...
      <div style={{ display: 'none' }}>
        <PrintableReceipt 
          ...
          onEntregadoChange={(e) => setEntregadoPor(e.target.value)}
          onRecibidoChange={(e) => setRecibidoPor(e.target.value)}
        />
      </div>
